...
const SelectLang = ({options, selected, onChange, open, setOpen}) => {
  ...
  return (
    <div className="selectContainer" ref={selectRef}>
      <div className="selectLangButton" onClick={() => setOpen(!open)}>
        <div className='selectTitle'>{selected.toLocaleUpperCase()}</div>
